...
*Results Reported in              : Table 7 row (iii) & Table 3, Column M, row (vi) Online Appendix for 1980-1990 
*-------------------------------------------------------------------------------
...
*-------------------------------------------------------------------------------
* Add the Value Added Data
merge m:1 Year using dta_files/VA_shares.dta
drop _merge

replace share_VA_HS_sector = share_VA_LS_sector if sector == 2

rename share_VA_HS_sector share_VA_BKRV_sector 
*-------------------------------------------------------------------------------

*-------------------------------------------------------------------------------
keep Year sector share_VA_BKRV_sector share_eff_BKRV_sector avg_share_eff_BKRV_HS avg_alpha_j_HS_BKRV

reshape wide share_VA_BKRV_sector share_eff_BKRV_sector avg_share_eff_BKRV_HS avg_alpha_j_HS_BKRV, i(Year) j(sector) 

rename avg_share_eff_BKRV_HS1 avg_share_eff_BKRV_HS
drop   avg_share_eff_BKRV_HS2

rename share_VA_BKRV_sector1 share_VA_BKRV_LS_sector 
rename share_VA_BKRV_sector2 share_VA_BKRV_HS_sector 
...
gen share_VA_BKRV_LS_sector_initial  = share_VA_BKRV_LS_sector  if Year == $Initial_Year
gen share_VA_BKRV_LS_sector_final    = share_VA_BKRV_LS_sector  if Year == $Final_Year
gen share_VA_BKRV_HS_sector_initial  = share_VA_BKRV_HS_sector  if Year == $Initial_Year
gen share_VA_BKRV_HS_sector_final    = share_VA_BKRV_HS_sector  if Year == $Final_Year
...
gen Delta_E_HS_sector_BKRV = share_VA_BKRV_HS_sector_final - share_VA_BKRV_HS_sector_initial
gen Delta_E_LS_sector_BKRV = share_VA_BKRV_LS_sector_final - share_VA_BKRV_LS_sector_initial
